...
export const BubbleStyle: React.FC = () => {
  const { bubbleColor, setBubbleColor, bubbleSticker, setBubbleSticker } =
    useStore();
  ...
  return (
    <div className="p-4 pt-0">
      <div className="text-[16px] font-semibold mb-2 text-[#333333]">
        彩蛋词气泡样式
      </div>

      <div className="mb-4">
        <div className="text-[14px] text-[#999999] mb-3">
          设置颜色（对本群全部彩蛋词气泡有效）
        </div>
        <div className="relative inline-block">
          <button
            className="bg-white border-none rounded-[20px] px-4 py-2 flex items-center gap-2 text-[14px] cursor-pointer shadow-sm"
